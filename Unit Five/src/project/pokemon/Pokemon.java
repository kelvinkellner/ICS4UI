...
class Pokemon {
	...
	{
		setStats(id, name, type, weakness, xpType, hpTotal, attack, defense, attackSpecial, defenseSpecial, speed, moves);
	}
	
	public Pokemon(int id, Pokemon[] defaults)
	{
		setStats(id, defaults[id-1].name, defaults[id-1].type, defaults[id-1].weakness, defaults[id-1].xpType, defaults[id-1].hpTotal, defaults[id-1].attack, defaults[id-1].defense, defaults[id-1].attackSpecial, defaults[id-1].defenseSpecial, defaults[id-1].speed, defaults[id-1].moves);
	}
	
	private void setStats(int id, String name, String[] type, String[] weakness, int xpType, int hpTotal, int attack, int defense, int attackSpecial, int defenseSpecial, int speed, Move[] moves) {
		this.id = id;
		this.name = name;
		this.type = type;
