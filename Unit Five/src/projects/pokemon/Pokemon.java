...
class Pokemon {
	...
	public Pokemon(int[][] bases, int id, String name, String type, String weakness, int xpType, int hpTotal, int attack, int defense, int attackSpecial, int defenseSpecial, int speed)
	{
		this.bases = bases;
